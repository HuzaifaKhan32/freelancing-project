  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col">
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4">
            <div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuBW3PmSVUeHe8AC6QRfrmS74wQjSjn1iLuwTlp04lrDG1sB4k-_xZqe9MAqREb5vaSgNmoy9KSM-3X9Vj3e7htBcbTgCXVYJyUPZNOVuHYHomuxOt6gcQfSn1-gVe1LNpRlAG0nQbouj8E7Ug8ikmYZ9yqSCbxod5v8T1mq3slsXTek1AWqD4xmygaib-5fWoiZ3j1fUzqhc1jgUyi4ecCLMC3588v2CxAc3pTLb8fImo7YPzr5AiePmbSJqgjaEFc2JXzCz3dNu9iU")',
              }}
            >
        ...
        <section className="w-full py-12 md:py-24">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center gap-4 text-center">
              <h2 className="text-text-light dark:text-text-dark text-3xl font-bold tracking-tight">
                Our Story
              </h2>
              <p className="max-w-3xl text-text-secondary-light dark:text-text-secondary-dark text-base md:text-lg leading-relaxed">
        ...
        <section className="w-full py-12 md:py-24 bg-content-light dark:bg-content-dark">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center gap-4 text-center">
              <h2 className="text-text-light dark:text-text-dark text-3xl font-bold tracking-tight">
                Our Lookbook
              </h2>
              <p className="max-w-2xl text-text-secondary-light dark:text-text-secondary-dark text-base md:text-lg">
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-4">
              <img
                ...
                data-alt="A woman wearing a white graphic tee posing against a colorful wall."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDcVUbwKI8y3HSCqSDnUazseGbKprY_ygwpA_M5DJv552idTXccW44B4gHQmJa8dIQ8xeUAuZQwiAOd3NngVQ2cNU8Vbp1qKoDhCV1GWHsu1zSdxuFzydU0dmVJdw9yHr4igM__eXLHpfERu-A8Mu-werU5ONkHQbuktZbquk-Ne1o3mDeA_jyXY4qO9f6A5nh4d2eI52Gz2K_h0LE54Dl1PtRrDTCKQTJwXZPmKr9yZrmqluv8ZPQDaO9VWJxFwisiMyR7ORxEDRx2"
              />
              <img
                className="rounded-lg object-cover aspect-[3/4]"
                data-alt="A man in a black t-shirt laughing with friends outdoors."
              ...
              <img
                className="rounded-lg object-cover aspect-[3/4]"
                data-alt="Close-up on the fabric and print of a custom designed t-shirt."
              ...
              <img
                className="rounded-lg object-cover aspect-[3/4]"
                data-alt="A group of people wearing matching brand t-shirts at an event."
        ...
        <section className="w-full py-12 md:py-24">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center gap-4 rounded-xl bg-background-light dark:bg-content-dark p-8 md:p-12 text-center">
              <h2 className="text-text-light dark:text-text-dark text-3xl font-bold tracking-tight">
